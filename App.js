    ...
    <NavigationContainer>
      <View style={styles.container}>
        ...
        <Stack.Navigator screenOptions={({ route }) => ({
          ...
          <Stack.Screen name="CustomerDetails" component={CustomerDetails}  options={{ headerStyle: { backgroundColor: '#ffa600', }, headerTintColor: "white", title: "Customer Details", headerShown: false }} />
